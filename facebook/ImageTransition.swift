...
class ImageTransition: BaseTransition {
    ...
    override func presentTransition(containerView: UIView, fromViewController: UIViewController, toViewController: UIViewController) {
        let destinationViewController = toViewController as! PhotoDetailViewController
    ...
    private func buildFinalImageFrame(destinationViewController: PhotoDetailViewController) -> CGRect {
